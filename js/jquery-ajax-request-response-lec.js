$(document).ready(function(){
     ...
     */
var hookbinUrl = "https://hookb.in/Z2dJmdXaLKFR33eLJPlX";
...
var swapiBaseURL = "https://swapi.dev/api/";
 ...
 // });
     ...
     */
//     var newHopeSwapi = $.ajax(swapiBaseURL + 'films/',{
//         method: "GET",
//         data: {
//             search: "A New Hope"
//         }
//     });
//
// newHopeSwapi.done(function (data){
...
// });
     ...
     * Canterbury Tales."
     */
   var bookCanter = $.ajax("data/books.json");
    bookCanter.done(function(data){
        data.forEach(function(books){
            if (books.title === "The Canterbury Tales"){
